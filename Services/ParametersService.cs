...
namespace EXPEDIT.Geology.Services {
    ...
    public class ParametersService : IParametersService
    {
        ...
        private readonly EXPEDIT.Geology.Services.IPrivateDataService _privateService;
        private readonly IUsersService _users;
        public ParametersService(IOrchardServices orchardServices, EXPEDIT.Geology.Services.IPrivateDataService privateService, IUsersService users)
        {
            _users = users;
